<?php 
    ...
    $questions = [
        ...
        [
            'question' => 'В якому році Україна відновила незалежність?',
        ...
        [
            'question' => 'Яка подія ознаменувала початок Першої світової війни?',
            'answers' => ['Смерть Франца Фердинанда', 'Французька революція', 'Російська революція', 'Падіння Берлінської стіни'],
            'correct_answer' => 'Смерть Франца Фердинанда'
        ],
        [
